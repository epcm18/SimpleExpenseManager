...
public interface TransactionDAO {
     ...
     */
    void logTransaction(Date date, String accountNo, ExpenseType expenseType, double amount);
     ...
     */
    List<Transaction> getAllTransactionLogs() throws ParseException;
     ...
     */
    List<Transaction> getPaginatedTransactionLogs(int limit) throws ParseException;
}
